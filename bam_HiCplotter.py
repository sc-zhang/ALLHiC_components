...
def ALLHiC_plot(bam, chrlist, npzfile, minsize, binsize, draw_line, draw_grid, outdir):
...
if __name__ == "__main__":
    ...
    draw_line = opts.line
    draw_grid = opts.grid
    ALLHiC_plot(bam, chrlist, npzfile, minsize, binsize, draw_line, draw_grid, outdir)
